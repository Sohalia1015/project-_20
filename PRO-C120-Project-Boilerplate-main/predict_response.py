...
# Load data files
intents = json.loads(open('C:/Users/Duvashi Family/Downloads/PRO-C120-Project-Boilerplate-main/PRO-C120-Project-Boilerplate-main/intents.json').read())
words = pickle.load(open('C:/Users/Duvashi Family/Downloads/PRO-C120-Project-Boilerplate-main/words.pkl','rb'))
classes = pickle.load(open('C:/Users/Duvashi Family/Downloads/PRO-C120-Project-Boilerplate-main/classes.pkl','rb'))
